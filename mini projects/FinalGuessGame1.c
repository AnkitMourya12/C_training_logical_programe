...
//void enter_IN_game(int,int,int,int,int);
void enter_IN_game(int min,int max,int level,int max_attempts,int number)
{
...
void game_screen(int level, int number)
{
    ...
    switch (level)
    {
        case 1: // Easy
            ...
            min=1;
            max=100;
            enter_IN_game(min,max,level,10,number);
            break;
        case 2: // Medium
             ...
             min=100;
             max=1000;
            enter_IN_game(min,max,level,7,number);
            break;
        case 3: // Hard
            //max_attempts = 5;
             min=1;
             max=10000;
            enter_IN_game(min,max,level,5,number);
            break;
        default:
            //max_attempts = 0;
            break;
